    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/AdminAp.php" style="font-size: 1rem;">
              Аудит
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="/AdminComm.php" style="font-size: 1rem; color: rgb(141, 130, 242);">
              Отзывы
            </a>
          </li>
        </ul>
